...
from .pipplware.web.bottle_websocket.geventwebsocket.protocols.base import BaseProtocol
...
class WampProtocol(BaseProtocol):
    ...
    def do_handshake(self):
        from pipplware.web.bottle_websocket.geventwebsocket import get_version
